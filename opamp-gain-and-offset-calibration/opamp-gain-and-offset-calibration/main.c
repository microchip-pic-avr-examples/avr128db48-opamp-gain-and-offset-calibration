...
int main(void)
{
	...
	OPAMP.OP0INMUX = OPAMP_MUXPOS_DAC_gc | OPAMP_MUXNEG_WIP_gc;
	OPAMP.OP0RESMUX = OPAMP_MUXBOT_GND_gc | OPAMP_MUXWIP_WIP7_gc | OPAMP_MUXTOP_OUT_gc;
	// Configure OP0 Control A
	OPAMP.OP0CTRLA = OPAMP_RUNSTBY_bm |  OPAMP_OUTMODE_NORMAL_gc | OPAMP_ALWAYSON_bm;
	...
	OPAMP.OP0INMUX = OPAMP_MUXPOS_INP_gc | OPAMP_MUXNEG_WIP_gc;
